                        ...
                        <?php while ($task = $recentTasks->fetch(PDO::FETCH_ASSOC)): ?>
                            <div class="task-item">
                                <div class="task-info">
                                    ...
                                    <span class="status-badge <?php echo getStatusClass(isset($task['status']) ? $task['status'] : "En Attente"); ?>">
                                        <?php echo htmlspecialchars(isset($task['status']) ? $task['status'] : "En Attente"); ?>
                                    </span>
                                </div>
                                <div class="task-meta">
